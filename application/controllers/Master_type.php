...
class Master_type extends CI_Controller {
    ...
    public function store()
    {
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            $target_dir = "uploads/master_type/";
            ...
            if (!$filename) {
                ...
                redirect(base_url("master_type/create"));
    ...
    public function update()
    {
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            if(!$filename) {
                ...
                redirect(base_url("master_type/index"));
    ...
    public function ajax_list_product_category()
    {
        ...
        if(sizeof($posts) > 0) {
            ...
            foreach($posts as $key => $value) {        
                ...
                $image = "<img src='" . base_url() . "uploads/master_type/" . $value->image . "' width='50px' height='50px'>";
                
                $action = "
                    <a href='".base_url()."master_type/edit/".$value->id."' 
                    ...
                    <a onclick='".'return confirm("'."delete this item?".'")'."'
                        href='".base_url()."master_type/delete/".$value->id."' class='btn btn-danger btn-sm delete-list'>
