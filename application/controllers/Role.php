    ...
    public function ajax_list_product_category()
    {
        ...
        if(sizeof($posts) > 0) {
            ...
            foreach($posts as $key => $value) {        
                ...
                $image = "<img src='" . base_url() . "uploads/role/" . $value->image . "' width='50px' height='50px'>";
                ...
                $action = "
                    ...
                    <a onclick='".'return confirm("'."delete this item?".'")'."'
                        href='".base_url()."role/delete/".$value->id."' class='btn btn-danger btn-sm delete-list'>
