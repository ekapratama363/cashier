...
class Content_detail_model extends CI_Model
{
    ...
    public function set_content_detail($data) 
    {
        return $this->db->insert('content_detail', $data);
    }

    public function ajax_content_detail()
    {
    ...
    public function get_ajax_list_content_detail($data)
    {
        
        $match = isset($data['search']) ? $data['search'] : '';
            
        $query = $this->db
                ->select('content_detail.id, content_detail.title, content_detail.description, content_detail.icon,
    ...
    public function get_content_detail_by_id($id)
    {
    
        $query = $this->db
                ->select('content_detail.id, content_detail.content_id, content_detail.title, content_detail.description, content_detail.icon,
                    content.title as content_title, content.page')
                ->from('content_detail')
                ->join('content', 'content.id = content_detail.content_id', 'left')
    ...
    public function update_content_detail_by_id($id, $data)
    {
    ...
    public function delete_content_detail_by_id($id)
    {
        $this->db->where(['id' => $id]);
	    $this->db->delete('content_detail');
    }

    public function ajax_get_content_detail($q = NULL)
    {
        if($q) {
