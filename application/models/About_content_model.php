...
class About_content_model extends CI_Model
{
    ...
    public function ajax_get_about_content($q = NULL, $data = NULL)
    {
        if($q) {
    ...
    public function get_ajax_list_about_content($data = NULL)
    {
    ...
    public function get_about_content($data = NULL) 
    {
