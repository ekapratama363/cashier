...
class Content_circle_left_model extends CI_Model
{
    ...
    public function set_content_circle_left($data) 
    {
        return $this->db->insert('content', $data);
    }

    public function ajax_get_content_circle_left($q = NULL, $data = NULL)
    {
        if($q) {
    ...
    public function get_ajax_list_content_circle_left($data = NULL)
    {
    ...
    public function get_content_circle_left_by_id($id)
    {
    ...
    public function update_content_circle_left_by_id($id, $data)
    {
    ...
    public function delete_content_circle_left_by_id($id)
    {
        $this->db->where(['id' => $id]);
	    $this->db->delete('content');
    }

    public function get_content_circle_left($data = NULL) 
    {
