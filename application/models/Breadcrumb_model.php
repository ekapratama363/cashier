...
class Breadcrumb_model extends CI_Model
{
    ...
    public function set_breadcrumb($data) 
    {
        return $this->db->insert('content', $data);
    }

    public function ajax_get_breadcrumb($q = NULL, $data = NULL)
    {
        if($q) {
    ...
    public function get_ajax_list_breadcrumb($data = NULL)
    {
    ...
    public function get_breadcrumb_by_id($id)
    {
    ...
    public function update_breadcrumb_by_id($id, $data)
    {
    ...
    public function delete_breadcrumb_by_id($id)
    {
        $this->db->where(['id' => $id]);
	    $this->db->delete('content');
    }

    public function get_breadcrumb($data = NULL) 
    {
